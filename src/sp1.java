...
public class sp1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(715, 450));
        ...
        jp1.setBounds(260, 390, 220, 20);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/download.png"))); // NOI18N
        jLabel1.setText("jLabel1");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(-90, 0, 770, 450);

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/black18.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(sp1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
class UserThread extends Thread
{
    sp1 s1;
    JProgressBar jp1;
    UserThread(sp1 s,JProgressBar jp)
    {
        s1=s;
        jp1=jp;
        start();
